...
settings <- elisa_analysis_setup(
  main_path = "~/Desktop/2_Source files/Figure S1/S1C_ELISA_3xKO/",
...
if (normalize_data) {
  ...
  CHARMS_3xKO_normalized <- process_ELISA_data(DF = CHARMS_3xKO, NEGATIVE_CTRL = "cl204", POSITIVE_CTRL = "cl011")
  
  plotting_data  <- rbind(CHARMS_3xKO_normalized)
} else {
