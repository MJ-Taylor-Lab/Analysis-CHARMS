...
write.csv(Cumulative_TRAF6, "Cumulative_TRAF6_232_CHARMS.csv", row.names = F, )
...
write.csv(Results, "Cumulative_TRAF6_Results_232_CHARMS.csv", row.names = F, )
...
ggsave(
  "Cumulative TRAF6 recruitment_232_CHARMS.pdf",
  #scale = 1,
  units = "cm",
  family = "Helvetica",
  height = 7,
