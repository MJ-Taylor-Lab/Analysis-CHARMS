...
write.csv(Cumulative_TRAF6, "Cumulative_TRAF6_321_CHARMS-bDLD.csv", row.names = F, )
...
write.csv(Results, "Cumulative_TRAF6_Results_321_CHARMS-bDLD.csv", row.names = F, )
...
ggsave(
  "Cumulative TRAF6 recruitment_321_CHARMS-bDLD_2.pdf",
  #scale = 1,
  units = "cm",
  family = "Helvetica",
  height = 7,
