...
write.csv(Cumulative_TRAF6, "Cumulative_TRAF6_1x_1xA.csv", row.names = F, )
...
write.csv(Results, "Cumulative_TRAF6_Results_1x_1xA.csv", row.names = F, )

# Line plot of cumulative TRAF6 recruitment_1x_1xA ----
ggplot(
  Results,
  aes(
  ...
  scale_color_manual(values = c("#fdcc8a","#cbc9e2")) +
  scale_fill_manual(values = c("#fdcc8a","#cbc9e2")) +
  labs(
...
ggsave(
  "Cumulative TRAF6 recruitment_T6BM_1x_1xA.pdf",
  #scale = 1,
  units = "cm",
  family = "Helvetica",
  height = 4,
