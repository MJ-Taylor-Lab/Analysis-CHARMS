...
settings <- elisa_analysis_setup(
  main_path = "~/Desktop/2_Source files/Figure S12/S12E_ELISA_CHARMS-bDD-3x-5xT6BM/",
...
if (normalize_data) {
  CHARMS_bDD_3x_5xT6BM    <- plate_data %>% filter(Date == "2024-12-23")
  
  CHARMS_bDD_3x_5xT6BM_normalized <- process_ELISA_data(DF = CHARMS_bDD_3x_5xT6BM, NEGATIVE_CTRL = "cl204", POSITIVE_CTRL = "cl069")
  
  plotting_data  <- rbind(CHARMS_bDD_3x_5xT6BM_normalized)
} else {
...
result <- prepare_elisa_plot(plotting_data)
