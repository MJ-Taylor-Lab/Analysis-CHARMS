...
write.csv(Cumulative_TRAF6, "Cumulative_TRAF6_5x_5xA.csv", row.names = F, )
...
write.csv(Results, "Cumulative_TRAF6_Results_5x_5xA.csv", row.names = F, )

# Line plot of cumulative TRAF6 recruitment_5x_5xA ----
ggplot(
  Results,
  aes(
  ...
  scale_color_manual(values = c("#b30000","#6a51a3")) +
  scale_fill_manual(values = c("#b30000","#6a51a3")) +
  labs(
...
ggsave(
  "Cumulative TRAF6 recruitment_T6BM_5x_5xA.pdf",
  #scale = 1,
  units = "cm",
  family = "Helvetica",
  height = 4,
