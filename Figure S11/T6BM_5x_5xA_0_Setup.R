...
TablePaths <- c(
  ...
  "~/20231108 2nM_cl265_TRAF6_MyD88-GFP-synTRAF6-BD-5xA 001/Essential.csv.gz",
  "~/20231102 2nM_cl265_TRAF6_MyD88-GFP-synTRAF6-BD-5xA 001/Essential.csv.gz",
  "~/20230317 1.5nM_cl265_TRAF6_MyD88-GFP-synTRAF6-BD-5xA 001/Essential.csv.gz"
)
...
Table$COHORT <- factor(Table$COHORT, levels = c("MyD88-GFP-synTRAF6-BD-5x TRAF6", "MyD88-GFP-synTRAF6-BD-5xA TRAF6"))
